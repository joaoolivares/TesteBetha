		...
		<div class="row">
			...
			<div class="col-md-12"> 
				<div class="cad-endereco">
                                    <h1><img src="<?php echo base_url('public/images/etapa2.png') ?>"> INFORME SEU ENDERECO</h1>
			...
			<div class="col-md-12"> 
					...
					<tr>
						...
						<td><?php echo form_submit('submit', 'ENVIAR ARQUIVO', 'class="btn btn-primary"'); ?></td>
                            ...
                            <div class="finalizar-cad"> <?php echo form_submit('submit', 'CADASTRAR CONTRIBUINTE', 'class="btn btn-primary"'); ?> </div>
			</div>
		</div>
	</section>
</div>